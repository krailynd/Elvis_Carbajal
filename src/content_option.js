...
// --- Backend, Desktop & Systems ---
{
    ...
    title: "Open-SahaDisk",
    description: "Open-source terminal file manager & disk-usage analyzer in Rust (Linux/macOS/Windows) — safe file operations with pre-flight risk assessment, background folder sizing, integrated Docker manager, cleanup engine and doctor diagnostics. First open-source project of my SahaHacking org (MIT).",
...
},
{
    ...
    description: "REST API for inventory management built in Java, with relational database design.",
...
},
{
    section: "Backend, Desktop & Systems",
    title: "Java Login",
    description: "Authentication system built in Java — user management and secure login flows.",
...
},
{
    ...
    description: "A dynamic markdown-based notepad desktop application built in Java.",
...
},
{
    section: "Backend, Desktop & Systems",
    title: "SahaCalc",
    description: "Java calculator + graphing tool for math functions.",
...
},
{
    section: "Backend, Desktop & Systems",
    title: "SahaTools",
    description: "Operations console (FastAPI + Docker) on my SahaCloud server — live service monitoring, utilities and document tools for the whole self-hosted ecosystem.",
...
},
{
    section: "Backend, Desktop & Systems",
    title: "SahaCloud",
    description: "My self-hosted personal cloud — an Ubuntu Server homelab running ~25 Docker containers behind a Caddy reverse proxy and Cloudflare Tunnels: Nextcloud, Mattermost, Outline docs, code-server, n8n automation, Home Assistant, SearXNG and more, across 12+ subdomains.",
...
},
{
    ...
    description: "Automation toolkit in Bash/Nushell for SFTP/SSH workflows on Linux.",
...
},
{
    section: "Backend, Desktop & Systems",
    title: "java-proyects",
    description: "My Java learning repository — university projects (UPSJB), exercises and mini-apps documenting my progress in the language.",
...
// --- Frontend & Web ---
{
    ...
    description: "Educational platform & virtual lab with 31+ interactive physics/math simulators. Led a multidisciplinary team; built secure auth (OAuth/JWT), real-time chat and responsive scientific UI. Self-hosted on my own server.",
...
},
{
    ...
    description: "Corporate website frontend for a Peruvian ed-tech company — educational robotics, AI & programming courses, STEAM programs, official distributor catalog, blog, quote flows and certifications pages.",
...
},
{
    section: "Frontend & Web",
    title: "Pages-rycle",
    description: "Web page with PHP backend and email delivery via PHPMailer — freelance web work.",
...
// --- Data Science & AI — In Training ---
{
    ...
    description: "[In progress] My first full data-to-model workflow — Pandas, feature engineering, Logistic Regression vs Random Forest.",
...
},
{
    ...
    description: "[Planned] Streamlit / Power BI dashboard: business questions answered with live filters — the daily work of a Data Analyst.",
    img: "",
...
},
{
    ...
    description: "[Planned] Imbalanced classes, F1/Recall metrics and business storytelling.",
    img: "",
    github: "https://github.com/krailynd",
},
{
    ...
    description: "[Planned] Automated data collection pipeline from raw sources to time-series analysis.",
    img: "",
    github: "https://github.com/krailynd",
},
{
    ...
    description: "[Planned] Embeddings, vector search and an LLM answering from UPSJB notes.",
    img: "",
    github: "https://github.com/krailynd",
},
{
    ...
    description: "[Planned] INEI/BCRP data → model → FastAPI → deployed on my own server.",
    img: "",
    github: "https://github.com/krailynd",
},
];
